		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comquotequotations-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comquotequotations-display": {
								"semanticObject": "comquotequotations",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.quote.quotations",
									"url": sap.ui.require.toUrl("com/quote/quotations")
								}
							}
						}
					}
